...
int run()
{
     char local_buf[21 + 3][10];
     memset(local_buf, 0, 21 + 3 * 10);
     for (;;)
     {
          puts("plz gief inpt");
          char command = fgetc(
...
# 21 "vuln.c"
          ...
          case 'o':
               ...
               break;
          case 'l':
               memcpy(global_buf, local_buf, sizeof(local_buf) < strlen((char *)local_buf) ? sizeof(local_buf) : strlen((char *)local_buf));
               break;
          case 'g':
               memcpy(local_buf, global_buf, sizeof(global_buf) < strlen(global_buf) ? sizeof(global_buf) : strlen(global_buf));
               break;
          case 'f':
               memcpy(local_buf, global_buf,
# 25 "vuln.c" 3 4
                      8192
# 25 "vuln.c"
                          / 8);
